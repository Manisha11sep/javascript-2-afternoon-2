...
/* 
  ...
  Above you're given a function that will return a random number between 0 and 30. There is also a 
  commented out array full of numbers 
  to help you visualize what your function will be receiving.
  
  Write a function named finder that will get a random number
   (by invoking getRandomArbitrary).
  Loop through the array (that will be passed in as a parameter) to see
...
//Code Here
// let numbers = [2, 5, 7]; num = 7

function finder(numbers){
  var num = getRandomArbitrary();
  console.log("randome is" +num);
  // let result = false;
...
/*
  ...
  Write a function called removeItem that is given two arguments, the first is myGroceryList, and the second
...
function removeItem(myGroceryList, item)
{
  ...
  {
    //myGroceryList[i].slice[i]
     // console.log("new list is " + myGroceryList[i]);
...
/*
  A very clean way to pass around large LISTS (arrays) of COLLECTIONS (objects) of Data is to have 
  an Array full of objects. Create an empty array called users.
*/
...
/*
  ...
  It's easy to imagine that your followers list on Twitter is an Array full of objects and those objects
